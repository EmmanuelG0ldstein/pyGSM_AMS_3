...
if __name__=='__main__':
    ...
    lot1= Orca.from_options(states=[(1,0)],charge=0,basis=basis,functional=functional,nproc=nproc,fnm=filepath1)
    lot2 = Orca(lot1.options.copy().set_values({'fnm':filepath2}))
